			...
			<section class="hero">
				...
				<div class="hero__content">
					<h1 class="font-medium" data-aos="fade-up" data-aos-duration="900"
						>Why Choose<br /><span class="gradient-heading"> Docmedilink?</span>
					</h1>
				</div>
			</section>
			<!--====|| Hero Section End ||====-->
    ...
    <!--====|| Why Choose Items	Section Start ||====-->
			<section class="why-choose lg:pb-[120px] relative z-10">
				...
				<div class="container mx-auto relative z-10">
					...
					<div
						class="serve-cards grid md:grid-cols-2 grid-cols-1 lg:gap-x-[200px] sm:gap-x-10 gap-x-5 gap-y-12 lg:mt-10 mt-0"
					>
						<div class="serve-card md:text-start text-center">
							<i
								class="icon-idea text-[130px] inline-block"
								data-aos="fade-up-right"
								data-aos-duration="700"
							></i>
							<h3
								class="font-bold mt-4 pb-3"
								style="border-bottom: 1px solid #dadef2"
								data-aos="fade-up-right"
								data-aos-duration="900"
								>Innovation</h3
							>
							<p
								class="serve__desc mt-4"
								data-aos="fade-up-right"
						...
						<div class="serve-card md:text-start text-center">
							<i
								class="icon-mobile text-[130px] inline-block"
						...
						<div class="serve-card md:text-start text-center">
							<i
								class="icon-lock text-[130px] inline-block"
								data-aos="fade-up-right"
								data-aos-duration="700"
							></i>
							<h3
					...
					<div class="text-center max-w-[610px] mx-auto lg:mt-20 mt-10">
						...
						<p
							...
							data-aos="fade-up"
							data-aos-duration="900"
							>With Docmedilink, you're not just investing in a platform; you're
