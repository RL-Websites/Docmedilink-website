                ...
                <div class="grid grid-cols-12 gap-x-5 md:gap-y-12 gap-y-7 mt-4">
                    <div class="md:col-span-7 col-span-12">
                        <div class="flex flex-col h-full">
                            <h4
                                class="font-bold mb-4 md:text-start text-center"
                                data-aos="fade-up-right"
                                data-aos-duration="700"
                                >Virtual <span class="text-primary">Consultation</span>
                            </h4>
                            <div
                                class="all-service__card bg-blue-light-2"
                                data-aos="fade-up-right"
                                data-aos-duration="1000"
                            >
                                <div class="all-service__left lg:pe-7 pe-5">
                                    <p
                                        >Offer seamless, secure, and HIPAA-compliant video and
                                        audio consultations, enabling healthcare providers to
                                        deliver high-quality care from anywhere. Our platform
                                        supports interactive questionnaires and real-time data
                                        sharing to optimize patient interaction and outcomes. </p
                                    >
                                </div>
                    ...
                    <div class="md:col-span-5 col-span-12">
                        <div class="flex flex-col h-full">
                            ...
                            <div
                                class="all-service__card bg-blue-light-3"
                                data-aos="fade-up-left"
                                data-aos-duration="1000"
                            >
                                <div
                                ...
                                >
                                    <p
                                        ...
                                        tasks, our solutions are tailored to fit the unique needs
                                        of your healthcare business. </p
                                    >
                                </div>
                                <div class="all-service__right">
                                    <img
                    ...
                    <div class="md:col-span-5 col-span-12">
                        <div class="flex flex-col h-full">
                            ...
                            <div
                                class="all-service__card bg-blue-light-4"
                                data-aos="fade-up-right"
                                data-aos-duration="1000"
                            >
                    ...
                    <div class="md:col-span-7 col-span-12">
                        <div class="flex flex-col h-full">
                            <h4
                                ...
                                data-aos="fade-up-left"
                                data-aos-duration="700"
                                >Data <span class="text-primary">Security & Analysis</span>
                            </h4>
                            <div
                            ...
                            >
                                <div class="all-service__left pe-7">
                                    <p
                                        ...
                                        workflow. Lab test kits can be ordered or patients can
                                        visit partner labs for diagnostics, with results feeding
                                        directly into the system for review and action. </p
                                    >
                                </div>
                                <div class="all-service__right pe-5">
                                    <img
